...
const Index = () => {
  return (
    <main className="w-full h-[85vh] md:h-[87.5vh] flex flex-col items-center">
      ...
      <Link to="/create" className="absolute animate-bounce  bottom-20 md:bottom-10 z-[4] right-10 w-20 h-20 flex items-center justify-center rounded-full shadow-2xl shadow-blue-800">
           <GrAdd/>
      </Link>
    </main>
  )
